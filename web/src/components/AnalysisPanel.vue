...
const getFlowDescription = (flowName) => {
  const descriptions = {
    '通用': '通用配置，适合所有流派',
    '鸣金·虹': '中远程均衡输出 - 无名剑 + 无名枪，攻守兼备万金油',
    '鸣金·影': '近战流血爆发 - 九剑 + 九曲枪，节奏感极强',
    '裂石·威': '坦克/近战输出 - 嗟夫刀 + 八方枪，团队前排',
    '裂石·钧': '横刀/首领增伤 - 十方破阵 + 斩雪刀，克制巨型 BOSS',
    '破竹·风': '近战高机动刺客 - 泥犁 + 粟子，专攻弱点',
    '破竹·鸢': '全能型控制/输出 - 天志 + 千机，战场适应性强',
    '破竹·尘': '伞/首领增伤 - 醉梦游春 + 粟子行云，控制辅助',
    '牵丝·霖': '纯治疗辅助 - 明川药典 + 千香蛊，团队生存保障',
    '牵丝·玉': '散武学增伤 - 九重春色 + 青山执笔，输出辅助',
  }
